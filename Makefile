...
ifneq (,$(findstring "$(PLATFORM)", "linux" "gnu_kfreebsd" "kfreebsd-gnu" "gnu"))
  ...
  ifeq ($(ARCH),x86_64)
    OPTIMIZEVM = -O3 -fno-math-errno -ffinite-math-only -fno-rounding-math -fno-signaling-nans -fno-trapping-math -mfpmath=sse -mmmx -m3dnow -msse -msse2 -funsafe-math-optimizations -Ofast
    OPTIMIZE = $(OPTIMIZEVM) -ffast-math
  endif
  ifeq ($(ARCH),x86)
    OPTIMIZEVM = -O3 -fno-math-errno -ffinite-math-only -fno-rounding-math -fno-signaling-nans -fno-trapping-math -mfpmath=sse -mmmx -m3dnow -msse -msse2 -funsafe-math-optimizations -Ofast
