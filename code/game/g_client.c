...
void SetWolfSpawnWeapons( gclient_t *client ) {
	...
	int starthealth = 500,i,numMedics = 0;   // JPW NERVE
...
{
	// 9mm
	ammoTable[WP_LUGER].maxammo = 1000; //1000;
	ammoTable[WP_MP40].maxammo = 1000; //1000;
	ammoTable[WP_MP34].maxammo = 1000; //1000;
	ammoTable[WP_STEN].maxammo = 1000; //1000;
	ammoTable[WP_SILENCER].maxammo = 1000; //1000;
	// 45cal
	ammoTable[WP_COLT].maxammo = 1000; //1000;
	ammoTable[WP_AKIMBO].maxammo = 1000; //1000;
	ammoTable[WP_THOMPSON].maxammo = 1000; //1000;
	// mauserammo
	ammoTable[WP_MAUSER].maxammo = 1000; //1000;
	ammoTable[WP_FG42].maxammo = 1000; //1000;
	ammoTable[WP_SNIPERRIFLE].maxammo = 1000; //1000;
	ammoTable[WP_FG42SCOPE].maxammo = 1000; //400;
	ammoTable[WP_G43].maxammo = 1000; //400;
	ammoTable[WP_MG42M].maxammo = 1000; //400;
	// barammo
	ammoTable[WP_BAR].maxammo = 1000; //300;
	ammoTable[WP_M1GARAND].maxammo = 1000; //300;
	// ppsh,tt33
	ammoTable[WP_TT33].maxammo = 1000; //400;
	ammoTable[WP_PPSH].maxammo = 1000; //400;
	// mosin
	ammoTable[WP_MOSIN].maxammo = 1000; //150;
	// mp44
	ammoTable[WP_MP44].maxammo = 1000; //200;
	// m97
	ammoTable[WP_M97].maxammo = 1000; //48;
	// revolver
	ammoTable[WP_REVOLVER].maxammo = 1000; //60;
	// throwables
	ammoTable[WP_GRENADE_LAUNCHER].maxammo = 1000; //10;
	ammoTable[WP_GRENADE_LAUNCHER].maxclip = 1000; //1000;
	ammoTable[WP_DYNAMITE].maxammo = 1000; //5;
	ammoTable[WP_DYNAMITE].maxclip = 1000; //5;
	ammoTable[WP_GRENADE_PINEAPPLE].maxammo = 1000; //10;
	ammoTable[WP_GRENADE_PINEAPPLE].maxclip = 1000; //10;
	// heavy weapons
	ammoTable[WP_PANZERFAUST].maxammo = 1000; //5;
	ammoTable[WP_FLAMETHROWER].maxammo = 1000; //250;
	ammoTable[WP_FLAMETHROWER].maxclip = 1000; //250;
	ammoTable[WP_TESLA].maxammo = 1000; //150;
	ammoTable[WP_TESLA].maxclip = 1000; //150;
	ammoTable[WP_VENOM].maxammo = 1000; //1500;
	// snooper
	ammoTable[WP_GARAND].maxammo = 1000; //15;
	ammoTable[WP_SNOOPERSCOPE].maxammo = 1000; //15;
...
{
	// 9mm
	ammoTable[WP_LUGER].maxammo = 1000; //300;
	ammoTable[WP_MP40].maxammo = 1000; //300;
	ammoTable[WP_MP34].maxammo = 1000; //300;
	ammoTable[WP_STEN].maxammo = 1000; //300;
	ammoTable[WP_SILENCER].maxammo = 1000; //300;
	// 45cal
	ammoTable[WP_COLT].maxammo = 1000; //250;
	ammoTable[WP_AKIMBO].maxammo = 1000; //250;
	ammoTable[WP_THOMPSON].maxammo = 1000; //250;
	// mauserammo
	ammoTable[WP_MAUSER].maxammo = 1000; //300;
	ammoTable[WP_FG42].maxammo = 1000; //300;
	ammoTable[WP_SNIPERRIFLE].maxammo = 1000; //300;
	ammoTable[WP_FG42SCOPE].maxammo = 1000; //300;
	ammoTable[WP_G43].maxammo = 1000; //300;
	ammoTable[WP_MG42M].maxammo = 1000; //300;
	// barammo
	ammoTable[WP_BAR].maxammo = 1000; //200;
	ammoTable[WP_M1GARAND].maxammo = 1000; //200;
	// ppsh,tt33
	ammoTable[WP_TT33].maxammo = 1000; //300;
	ammoTable[WP_PPSH].maxammo = 1000; //300;
	// mosin
	ammoTable[WP_MOSIN].maxammo = 1000; //100;
	// mp44
	ammoTable[WP_MP44].maxammo = 1000; //180;
	// m97
	ammoTable[WP_M97].maxammo = 1000; //36;
	// revolver
	ammoTable[WP_REVOLVER].maxammo = 1000; //42;
	// throwables
	ammoTable[WP_GRENADE_LAUNCHER].maxammo = 1000; //8;
	ammoTable[WP_GRENADE_LAUNCHER].maxclip = 1000; //8;
	ammoTable[WP_DYNAMITE].maxammo = 1000; //4;
	ammoTable[WP_DYNAMITE].maxclip = 1000; //4;
	ammoTable[WP_GRENADE_PINEAPPLE].maxammo = 1000; //8;
	ammoTable[WP_GRENADE_PINEAPPLE].maxclip = 1000; //8;
	// heavy weapons
	ammoTable[WP_PANZERFAUST].maxammo = 1000; //4;
	ammoTable[WP_FLAMETHROWER].maxammo = 1000; //200;
	ammoTable[WP_FLAMETHROWER].maxclip = 1000; //200;
	ammoTable[WP_TESLA].maxammo = 1000; //100;
	ammoTable[WP_TESLA].maxclip = 1000; //100;
	ammoTable[WP_VENOM].maxammo = 1000; //1000;
	// snooper
	ammoTable[WP_GARAND].maxammo = 1000; //10;
	ammoTable[WP_SNOOPERSCOPE].maxammo = 1000; //10;
}

void SetupWeaponsForSkill_HARD() // Hard
{
	// 9mm
	ammoTable[WP_LUGER].maxammo = 1000; //200;
	ammoTable[WP_MP40].maxammo = 1000; //200;
	ammoTable[WP_MP34].maxammo = 1000; //200;
	ammoTable[WP_STEN].maxammo = 1000; //200;
	ammoTable[WP_SILENCER].maxammo = 1000; //200;
	// 45cal
	ammoTable[WP_COLT].maxammo = 1000; //200;
	ammoTable[WP_AKIMBO].maxammo = 1000; //200;
	ammoTable[WP_THOMPSON].maxammo = 1000; //200;
	// mauserammo
	ammoTable[WP_MAUSER].maxammo = 1000; //200;
	ammoTable[WP_FG42].maxammo = 1000; //200;
	ammoTable[WP_SNIPERRIFLE].maxammo = 1000; //200;
	ammoTable[WP_FG42SCOPE].maxammo = 1000; //200;
	ammoTable[WP_G43].maxammo = 1000; //200;
	ammoTable[WP_MG42M].maxammo = 1000; //200;
	// barammo
	ammoTable[WP_BAR].maxammo = 1000; //180;
	ammoTable[WP_M1GARAND].maxammo = 1000; //180;
	// ppsh,tt33
	ammoTable[WP_TT33].maxammo = 1000; //250;
	ammoTable[WP_PPSH].maxammo = 1000; //250;
	// mosin
	ammoTable[WP_MOSIN].maxammo = 1000; //50;
	// mp44
	ammoTable[WP_MP44].maxammo = 1000; //150;
	// m97
	ammoTable[WP_M97].maxammo = 1000; //30;
    // revolver
	ammoTable[WP_REVOLVER].maxammo = 1000; //36;
	// throwables
	ammoTable[WP_GRENADE_LAUNCHER].maxammo = 1000; //6;
	ammoTable[WP_GRENADE_LAUNCHER].maxclip = 1000; //6;
	ammoTable[WP_DYNAMITE].maxammo = 1000; //3;
	ammoTable[WP_DYNAMITE].maxclip = 1000; //3;
	ammoTable[WP_GRENADE_PINEAPPLE].maxammo = 1000; //6;
	ammoTable[WP_GRENADE_PINEAPPLE].maxclip = 1000; //6;
	// heavy weapons
	ammoTable[WP_PANZERFAUST].maxammo = 1000; //3;
	ammoTable[WP_FLAMETHROWER].maxammo = 1000; //150;
	ammoTable[WP_FLAMETHROWER].maxclip = 1000; //150;
	ammoTable[WP_TESLA].maxammo = 1000; //100;
	ammoTable[WP_TESLA].maxclip = 1000; //100;
	ammoTable[WP_VENOM].maxammo = 1000; //1000;
	// snooper
...
{
	// 9mm
	ammoTable[WP_LUGER].maxammo = 1000; //150;
	ammoTable[WP_MP40].maxammo = 1000; //150;
	ammoTable[WP_MP34].maxammo = 1000; //150;
	ammoTable[WP_STEN].maxammo = 1000; //150;
	ammoTable[WP_SILENCER].maxammo = 1000; //150;
	// 45cal
	ammoTable[WP_COLT].maxammo = 1000; //150;
	ammoTable[WP_AKIMBO].maxammo = 1000; //150;
	ammoTable[WP_THOMPSON].maxammo = 1000; //150;
	// mauserammo
	ammoTable[WP_MAUSER].maxammo = 1000; //150;
	ammoTable[WP_FG42].maxammo = 1000; //150;
	ammoTable[WP_SNIPERRIFLE].maxammo = 1000; //150;
	ammoTable[WP_FG42SCOPE].maxammo = 1000; //150;
	ammoTable[WP_G43].maxammo = 1000; //150;
	ammoTable[WP_MG42M].maxammo = 1000; //150;
	// barammo
	ammoTable[WP_BAR].maxammo = 1000; //150;
	ammoTable[WP_M1GARAND].maxammo = 1000; //150;
	// ppsh,tt33
	ammoTable[WP_TT33].maxammo = 1000; //200;
	ammoTable[WP_PPSH].maxammo = 1000; //200;
	// mosin
	ammoTable[WP_MOSIN].maxammo = 1000; //50;
	// mp44
	ammoTable[WP_MP44].maxammo = 1000; //120;
	// m97
	ammoTable[WP_M97].maxammo = 1000; //24;
	// revolver
	ammoTable[WP_REVOLVER].maxammo = 1000; //24;
	// throwables
	ammoTable[WP_GRENADE_LAUNCHER].maxammo = 1000; //5;
	ammoTable[WP_GRENADE_LAUNCHER].maxclip = 1000; //5;
	ammoTable[WP_DYNAMITE].maxammo = 1000; //3;
	ammoTable[WP_DYNAMITE].maxclip = 1000; //3;
	ammoTable[WP_GRENADE_PINEAPPLE].maxammo = 1000; //5;
	ammoTable[WP_GRENADE_PINEAPPLE].maxclip = 1000; //5;
	// heavy weapons
	ammoTable[WP_PANZERFAUST].maxammo = 1000; //1;
	ammoTable[WP_FLAMETHROWER].maxammo = 1000; //100;
	ammoTable[WP_FLAMETHROWER].maxclip = 1000; //100;
	ammoTable[WP_TESLA].maxammo = 1000; //50;
	ammoTable[WP_TESLA].maxclip = 1000; //50;
	ammoTable[WP_VENOM].maxammo = 1000; //500;
	// snooper
	ammoTable[WP_GARAND].maxammo = 1000; //5;
	ammoTable[WP_SNOOPERSCOPE].maxammo = 1000; //5;
