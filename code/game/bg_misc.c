...
#define MAX_AMMO_45     1000
#define MAX_AMMO_9MM    1000
#define MAX_AMMO_VENOM  1000
#define MAX_AMMO_MAUSER 1000
#define MAX_AMMO_GARAND 1000
#define MAX_AMMO_FG42   MAX_AMMO_MAUSER
#define MAX_AMMO_BAR    1000
#define MAX_AMMO_TTAMMO 1000
#define MAX_AMMO_MOSINA 1000
#define MAX_AMMO_BARAMMO    1000  
#define MAX_AMMO_44AMMO     1000
#define MAX_AMMO_M97        1000
#define MAX_AMMO_REVOLVER   1000
...
ammotable_t ammoTable[] = {
	...
	{   MAX_AMMO_9MM,   1,      8,      1500,   DELAY_PISTOL,   350,    0,      0,      MOD_LUGER               },  //	WP_LUGER				// 2	
	...
	{   MAX_AMMO_VENOM, 1,      500,    3000,   750,            45,     3500,   200,    MOD_VENOM               },  //	WP_VENOM				// 8	
	...
	{   MAX_AMMO_9MM,   1,      8,      1500,   DELAY_PISTOL,   400,    0,      0,      MOD_SILENCER            },  //	WP_SILENCER				// 30
...
*/
	{
		"item_clipboard",
		"sound/pickup/armor/body_pickup.opus",
...
*/
	{
		"item_treasure",
		"sound/pickup/treasure/gold.opus",
...
*/
	{
		"item_health_small",
		"sound/pickup/health/health_pickup.opus",
...
*/
	{
		"item_health_turkey",
		"sound/pickup/health/hot_pickup.opus",
...
*/
	{
		...
		"sound/pickup/health/cold_pickup.opus",
...
*/
	...
	{
		"item_stamina_stein",
		"sound/pickup/health/stamina_pickup.opus",
...
*/
	...
	{
		"item_stamina_brandy",
		"sound/sound/pickup/health/stamina_pickup.opus",
...
*/
	{
		"item_armor_head",
		"sound/pickup/armor/head_pickup.opus",
...
*/
	{
		...
		WP_GRENADE_LAUNCHER,
		"",                      // precache
		"sound/weapons/grenade/hgrenb1a.wav sound/weapons/grenade/hgrenb2a.opus",             // sounds
		{0,0,0,0}
	},
...
*/
	{
		...
		WP_MORTAR,
		"",                      // precache
		"sound/weapons/mortar/mortarf1.opus",             // sounds
		{0,0,0,0}
	},
...
pickup sound : "sound/pickup/holdable/get_medkit.opus"
use sound : "sound/pickup/holdable/get_medkit.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
...
/*
	{
		"holdable_medkit",
		"sound/pickup/holdable/get_medkit.opus",
		{
		...
		0,
		"",				// precache
		"sound/pickup/holdable/use_medkit.opus",	// sounds
		{0,0,0,0}
	},
*/
...
pickup sound : "sound/pickup/holdable/get_wine.opus"
use sound : "sound/pickup/holdable/use_wine.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
model="models/powerups/holdable/wine.md3"
*/
	{
		"holdable_wine",
		"sound/pickup/holdable/get_wine.opus",
		{
		...
		0,
		"",                              // precache
		"sound/pickup/holdable/use_wine.opus",        // sounds
		{3,0,0,0}
	},
...
pickup sound : "sound/pickup/holdable/get_skull.opus"
use sound : "sound/pickup/holdable/use_skull.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
...
/*
	{
		"holdable_skull",
		"sound/pickup/holdable/get_skull.opus",
		{
		...
		0,
		"",								// precache
		"sound/pickup/holdable/use_skull.opus",	// sounds
		{0,0,0,0}
	},
*/
...
pickup sound : "sound/pickup/holdable/get_water.opus"
use sound : "sound/pickup/holdable/use_water.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
...
/*
	{
		"holdable_p_water",
		"sound/pickup/holdable/get_water.opus",
		{
		...
		0,
		"",								// precache
		"sound/pickup/holdable/use_water.opus",	// sounds
		{0,0,0,0}
	},
*/
...
pickup sound : "sound/pickup/holdable/get_elec.opus"
use sound : "sound/pickup/holdable/use_elec.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
...
/*
	{
		"holdable_p_elec",
		"sound/pickup/holdable/get_elec.opus",
		{
		...
		0,
		"",								// precache
		"sound/pickup/holdable/use_elec.opus",	// sounds
		{0,0,0,0}
	},
*/
...
pickup sound : "sound/pickup/holdable/get_fire.opus"
use sound : "sound/pickup/holdable/use_fire.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
...
/*
	{
		"holdable_p_fire",
		"sound/pickup/holdable/get_fire.opus",
		{
		...
		0,
		"",								// precache
		"sound/pickup/holdable/use_fire.opus",	// sounds
		{0,0,0,0}
	},
*/
...
pickup sound : "sound/pickup/holdable/get_stamina.opus"
use sound : "sound/pickup/holdable/use_stamina.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
model="models/powerups/holdable/stamina.md3"
*/
	{
		"holdable_stamina",
		"sound/pickup/holdable/get_stamina.opus",
		{
		...
		0,
		"",                              // precache
		"sound/pickup/holdable/use_stamina.opus", // sounds
		{0,0,0,0}
	},
...
*/
	{
		"holdable_book1",
		"sound/pickup/holdable/get_book1.opus",
		{
		...
		0,
		"",                              // precache
		"sound/pickup/holdable/use_book.opus",    // sounds
		{0,0,0,0}
	},
...
*/
	{
		"holdable_book2",
		"sound/pickup/holdable/get_book2.opus",
		{
...
*/
	{
		"holdable_book3",
		"sound/pickup/holdable/get_book3.opus",
		{
...
/*
	{
		"holdable_11",
		"sound/pickup/holdable/get_11.opus",
		{
		...
		0,
		"",								// precache
		"sound/pickup/holdable/use_11.opus",	// sounds
		{0,0,0,0}
	},
*/
...
/*
	{
		"holdable_12",
		"sound/pickup/holdable/get_12.opus",
		{
		...
		0,
		"",								// precache
		"sound/pickup/holdable/use_12.opus",	// sounds
		{0,0,0,0}
	},
*/
...
/*
	{
		"holdable_13",
		"sound/pickup/holdable/get_13.opus",
		{
		...
		0,
		"",								// precache
		"sound/pickup/holdable/use_13.opus",	// sounds
		{0,0,0,0}
	},
*/
...
/*
	{
		"holdable_14",
		"sound/pickup/holdable/get_14.opus",
		{
		...
		0,
		"",								// precache
		"sound/pickup/holdable/use_14.opus",	// sounds
		{0,0,0,0}
	},
*/
...
/
	{
		"holdable_15",
		"sound/pickup/holdable/get_15.opus",
		{
		...
		0,
		"",								// precache
		"sound/pickup/holdable/use_15.opus",	// sounds
		{0,0,0,0}
	},
...
*/
	{
		"team_CTF_redflag",
		"sound/teamplay/flagtk_red.opus",
		...
		0,
		"",                  // precache
		"sound/teamplay/flagcap_red.wav sound/teamplay/flagtk_red.wav sound/teamplay/flagret_red.opus",   // sounds
		{0,0,0,0}
	},
...
*/
	{
		"team_CTF_blueflag",
		"sound/teamplay/flagtk_blu.opus",
		...
		0,
		"",                  // precache
		"sound/teamplay/flagcap_blu.wav sound/teamplay/flagtk_blu.wav sound/teamplay/flagret_blu.opus",   // sounds
		{0,0,0,0}
	},
...
pickup sound : "sound/pickup/keys/skull.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
...
pickup sound : "sound/pickup/keys/chalice.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
...
/*
	{
		"key_chalice2",
		"sound/pickup/keys/chalice.opus",
		{
...
pickup sound : "sound/pickup/keys/eye.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
...
pickup sound : "sound/pickup/keys/radio.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
...
pickup sound : "sound/pickup/keys/satchelcharge.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
...
/*
	{
		"key_satchelcharge5",
		"sound/pickup/keys/satchelcharge.opus",
		{
...
pickup sound : "sound/pickup/keys/binocs.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
model="models/powerups/keys/binoculars.md3"
*/
	{
		"key_binocs",
		"sound/pickup/keys/binocs.opus",
		{
...
pickup sound : "sound/pickup/keys/key7.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
...
pickup sound : "sound/pickup/keys/key8.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
...
pickup sound : "sound/pickup/keys/key9.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
model="models/powerups/keys/key.md3"
*/
/*
...
pickup sound : "sound/pickup/keys/key10.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
model="models/powerups/keys/key.md3"
*/
/*
...
pickup sound : "sound/pickup/keys/key11.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
model="models/powerups/keys/key.md3"
*/
/*
...
pickup sound : "sound/pickup/keys/key12.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
model="models/powerups/keys/key.md3"
*/
/*
...
pickup sound : "sound/pickup/keys/key13.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
model="models/powerups/keys/key.md3"
*/
/*
...
pickup sound : "sound/pickup/keys/key14.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
model="models/powerups/keys/key.md3"
*/
/*
...
pickup sound : "sound/pickup/keys/key15.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
model="models/powerups/keys/key.md3"
*/
/*
...
pickup sound : "sound/pickup/keys/key16.opus"
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
model="models/powerups/keys/key.md3"
*/
/*
