...
//		ent->count = 1;
	...
	snd_boardbreak = G_SoundIndex( "sound/world/boardbreak.opus" );
	snd_chaircreak = G_SoundIndex( "sound/world/chaircreak.opus" );
	chair_metalbreak = G_SoundIndex( "sound/world/metal_chair_break.opus" );
...
void SP_Props_GenericChair( gentity_t *ent ) {
	...
	snd_boardbreak = G_SoundIndex( "sound/world/boardbreak.opus" );
	snd_glassbreak = G_SoundIndex( "sound/world/glassbreak.opus" );
	snd_metalbreak = G_SoundIndex( "sound/world/metalbreak.opus" );
	snd_ceramicbreak = G_SoundIndex( "sound/world/ceramicbreak.opus" );
	snd_chaircreak = G_SoundIndex( "sound/world/chaircreak.opus" );
	snd_chairthrow = G_SoundIndex( "sound/props/throw/chairthudgrunt.opus" );
	snd_chairhitground = G_SoundIndex( "sound/props/chair/chairthud.opus" );
}
