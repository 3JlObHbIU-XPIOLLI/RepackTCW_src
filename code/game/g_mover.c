...
void SP_func_secret( gentity_t *ent ) {
	...
	ent->sound1to2 = ent->sound2to1 = ent->sound2to3 = G_SoundIndex( "sound/movers/doors/dr1_strt.opus" );
	ent->soundPos1 = ent->soundPos3 = G_SoundIndex( "sound/movers/doors/dr1_end.opus" );
...
the default sounds are:
  "wood"	- "sound/world/boardbreak.opus"
  "glass"	- "sound/world/glassbreak.opus"
  "metal"	- "sound/world/metalbreak.opus"
  "gibs"	- "sound/player/gibsplit1.opus"
  "brick"	- "sound/world/brickfall.opus"
  "stone"	- "sound/world/stonefall.opus"
  "fabric"	- "sound/world/metalbreak.opus"	// (SA) temp
'leaktypes':
1:oil
2:water
3:steam
...
void SP_func_explosive( gentity_t *ent ) {
	...
	if ( G_SpawnString( "noise", "NOSOUND", &s ) ) {
		...
		switch ( ent->key ) {
		case 0:     // "wood"
			ent->s.dl_intensity = G_SoundIndex( "sound/world/boardbreak.opus" );
			break;
		case 1:     // "glass"
			ent->s.dl_intensity = G_SoundIndex( "sound/world/glassbreak.opus" );
			break;
		case 2:     // "metal"
			ent->s.dl_intensity = G_SoundIndex( "sound/world/metalbreak.opus" );
			break;
		case 3:     // "gibs"
			ent->s.dl_intensity = G_SoundIndex( "sound/player/gibsplit1.opus" );
			break;
		case 4:     // "brick"
			ent->s.dl_intensity = G_SoundIndex( "sound/world/brickfall.opus" );
			break;
		case 5:     // "stone"
			ent->s.dl_intensity = G_SoundIndex( "sound/world/stonefall.opus" );
			break;
...
The sound defaults to "sound/movers/invis_user_off.opus"
...
//----(SA)	end
	...
	if ( !( ent->spawnflags & 4 ) ) {    // !NO_OFF_NOISE
		if ( G_SpawnString( "offnoise", "0", &sound ) ) {
			...
			ent->soundPos1 = G_SoundIndex( "sound/movers/invis_user_off.opus" );
		}
	}
