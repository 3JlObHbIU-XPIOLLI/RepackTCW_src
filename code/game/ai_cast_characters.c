...
AICharacterDefaults_t aiDefaults[NUM_CHARACTERS] = {
	...
	//AICHAR_ZOMBIE
	{
		...
		},
		{
			...
			"zombiePain",
			"sound/weapons/melee/fstatck.opus",	// stay - you're told to stay put
			"sound/weapons/melee/fstmiss.opus",	// follow - go with ordering player ("i'm with you" rather than "yes sir!")
...
//----(SA)	changed per DK
//			"sound/weapons/melee/fstatck.opus",	// stay - you're told to stay put
			"sound/weapons/melee/warz_hit.opus",
//			"sound/weapons/melee/fstmiss.opus",	// follow - go with ordering player ("i'm with you" rather than "yes sir!")
			"sound/weapons/melee/warz_miss.opus",
...
void SP_ai_stimsoldier_dual( gentity_t *ent ) {
	...
	//
	level.stimSoldierFlySound = G_SoundIndex( "sound/stimsoldier/flyloop.opus" );
}
