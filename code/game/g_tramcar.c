...
void SP_func_tramcar( gentity_t *self ) {
	...
	if ( G_SpawnString( "noise", "NOSOUND", &s ) ) {
		...
		{
		case 0:     // "wood"
			self->s.dl_intensity = G_SoundIndex( "sound/world/boardbreak.opus" );
			break;
		case 1:     // "glass"
			self->s.dl_intensity = G_SoundIndex( "sound/world/glassbreak.opus" );
			break;
		case 2:     // "metal"
			self->s.dl_intensity = G_SoundIndex( "sound/world/metalbreak.opus" );
			break;
		case 3:     // "gibs"
			self->s.dl_intensity = G_SoundIndex( "sound/player/gibsplit1.opus" );
			break;
		}
	}
...
void SP_props_me109( gentity_t *ent ) {
	...
	fploop_snd = G_SoundIndex( "sound/fighterplane/fploop.opus" );
	fpchoke_snd = G_SoundIndex( "sound/fighterplane/fpchoke.opus" );
	fpattack_snd = G_SoundIndex( "sound/weapons/mg42/37mm.opus" );
	fpexpdebris_snd = G_SoundIndex( "sound/fighterplane/fpexpdebris.opus" );


	fpflyby1_snd = G_SoundIndex( "sound/fighterplane/fpflyby1.opus" );
	fpflyby2_snd = G_SoundIndex( "sound/fighterplane/fpflyby2.opus" );
	fpidle_snd = G_SoundIndex( "sound/fighterplane/fpidle.opus" );
	fpstartup_snd = G_SoundIndex( "sound/fighterplane/fpstartup.opus" );
...
void SP_truck_cam( gentity_t *self ) {
	...
	truck_sound = G_SoundIndex( "sound/vehicles/start_drive_grind_gears_01_11k.opus" );
	// truck_sound = G_SoundIndex ( "sound/vehicles/tankmove1.opus" );

	truck_idle_snd = G_SoundIndex( "sound/vehicles/truckidle.opus" );
	truck_gear1_snd = G_SoundIndex( "sound/vehicles/truckgear1.opus" );
	truck_gear2_snd = G_SoundIndex( "sound/vehicles/truckgear2.opus" );
	truck_gear3_snd = G_SoundIndex( "sound/vehicles/truckgear3.opus" );
	truck_reverse_snd = G_SoundIndex( "sound/vehicles/truckreverse.opus" );
	truck_moving_snd = G_SoundIndex( "sound/vehicles/truckmoving.opus" );
	truck_breaking_snd = G_SoundIndex( "sound/vehicles/truckbreaking.opus" );
	truck_bouncy1_snd = G_SoundIndex( "sound/vehicles/truckbouncy1.opus" );
	truck_bouncy2_snd = G_SoundIndex( "sound/vehicles/truckbouncy2.opus" );
	truck_bouncy3_snd = G_SoundIndex( "sound/vehicles/truckbouncy3.opus" );
}
