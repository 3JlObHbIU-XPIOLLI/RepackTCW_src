...
wake sound - "models/misc/grabber/grabber_wake.opus"
attack sound - "models/misc/grabber/grabber_attack.opus"
pain sound - "models/misc/grabber/grabber_pain.opus"
...
void SP_misc_grabber_trap( gentity_t *ent ) {
	...
	ent->soundPos1      = G_SoundIndex( "models/misc/grabber/grabber_wake.opus" );
	ent->sound1to2      = G_SoundIndex( "models/misc/grabber/grabber_attack.opus" );
	ent->sound2to1      = G_SoundIndex( "models/misc/grabber/grabber_pain.opus" );
...
void SP_sniper_brush( gentity_t *ent ) {
	...
	sniper_sound = G_SoundIndex( "sound/weapons/machinegun/machgf1b.opus" );
...
void mg42_spawn( gentity_t *ent ) {
	...
	ent->soundPos3 = G_SoundIndex( "sound/weapons/mg42/mg42_death.opus" );   // die sound
...
void SP_mg42( gentity_t *self ) {
	...
	snd_noammo = G_SoundIndex( "sound/weapons/noammo.opus" );
