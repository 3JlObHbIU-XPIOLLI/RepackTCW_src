...
static void CG_RegisterSounds( void ) {
	...
	cgs.media.n_health = trap_S_RegisterSound( "sound/items/n_health.opus" );
	cgs.media.noFireUnderwater = trap_S_RegisterSound( "sound/weapons/underwaterfire.opus" ); //----(SA)	added

	cgs.media.snipersound = trap_S_RegisterSound( "sound/weapons/mauser/mauserf1.opus" );
	cgs.media.tracerSound = trap_S_RegisterSound( "sound/weapons/machinegun/buletby1.opus" );
	cgs.media.selectSound = trap_S_RegisterSound( "sound/weapons/change.opus" );
	cgs.media.wearOffSound = trap_S_RegisterSound( "sound/items/wearoff.opus" );
	cgs.media.useNothingSound = trap_S_RegisterSound( "sound/items/use_nothing.opus" );
	cgs.media.gibSound = trap_S_RegisterSound( "sound/player/gibsplt1.opus" );
	cgs.media.gibBounce1Sound = trap_S_RegisterSound( "sound/player/gibimp1.opus" );
	cgs.media.gibBounce2Sound = trap_S_RegisterSound( "sound/player/gibimp2.opus" );
	cgs.media.gibBounce3Sound = trap_S_RegisterSound( "sound/player/gibimp3.opus" );

//	cgs.media.teleInSound = trap_S_RegisterSound( "sound/world/telein.opus" );
//	cgs.media.teleOutSound = trap_S_RegisterSound( "sound/world/teleout.opus" );
//	cgs.media.respawnSound = trap_S_RegisterSound( "sound/items/respawn1.opus" );


	cgs.media.grenadebounce[GRENBOUNCE_DEFAULT][0]  = trap_S_RegisterSound( "sound/weapons/grenade/hgrenb1a.opus" );
	cgs.media.grenadebounce[GRENBOUNCE_DEFAULT][1]  = trap_S_RegisterSound( "sound/weapons/grenade/hgrenb2a.opus" );
	cgs.media.grenadebounce[GRENBOUNCE_DIRT][0]     = trap_S_RegisterSound( "sound/weapons/grenade/hg_dirt1a.opus" );
	cgs.media.grenadebounce[GRENBOUNCE_DIRT][1]     = trap_S_RegisterSound( "sound/weapons/grenade/hg_dirt2a.opus" );
	cgs.media.grenadebounce[GRENBOUNCE_WOOD][0]     = trap_S_RegisterSound( "sound/weapons/grenade/hg_wood1a.opus" );
	cgs.media.grenadebounce[GRENBOUNCE_WOOD][1]     = trap_S_RegisterSound( "sound/weapons/grenade/hg_wood2a.opus" );
	cgs.media.grenadebounce[GRENBOUNCE_METAL][0]    = trap_S_RegisterSound( "sound/weapons/grenade/hg_metal1a.opus" );
	cgs.media.grenadebounce[GRENBOUNCE_METAL][1]    = trap_S_RegisterSound( "sound/weapons/grenade/hg_metal2a.opus" );

	cgs.media.dynamitebounce1 = trap_S_RegisterSound( "sound/weapons/dynamite/dynamite_bounce.opus" );

	cgs.media.fbarrelexp1 = trap_S_RegisterSound( "sound/weapons/flamebarrel/fbarrela.opus" );
	cgs.media.fbarrelexp2 = trap_S_RegisterSound( "sound/weapons/flamebarrel/fbarrelb.opus" );

	cgs.media.fkickwall = trap_S_RegisterSound( "sound/weapons/melee/fstatck.opus" );
	cgs.media.fkickflesh = trap_S_RegisterSound( "sound/weapons/melee/fstatck.opus" );
	cgs.media.fkickmiss = trap_S_RegisterSound( "sound/weapons/melee/fstmiss.opus" );

	cgs.media.noAmmoSound = trap_S_RegisterSound( "sound/weapons/noammo.opus" );

	cgs.media.talkSound = trap_S_RegisterSound( "sound/player/talk.opus" );
	cgs.media.landSound = trap_S_RegisterSound( "sound/player/land1.opus" );

	cgs.media.watrInSound = trap_S_RegisterSound( "sound/player/watr_in.opus" );
	cgs.media.watrOutSound = trap_S_RegisterSound( "sound/player/watr_out.opus" );
	cgs.media.watrUnSound = trap_S_RegisterSound( "sound/player/watr_un.opus" );

	cgs.media.underWaterSound = trap_S_RegisterSound( "sound/world/underwater03.opus" );
	...
	for ( i = 0 ; i < 4 ; i++ ) {
		...
		Com_sprintf( name, sizeof( name ), "sound/player/footsteps/wood%i.opus", i + 1 );
		cgs.media.footsteps[FOOTSTEP_WOOD][i] = trap_S_RegisterSound( name );

		Com_sprintf( name, sizeof( name ), "sound/player/footsteps/grass%i.opus", i + 1 );
		cgs.media.footsteps[FOOTSTEP_GRASS][i] = trap_S_RegisterSound( name );

		Com_sprintf( name, sizeof( name ), "sound/player/footsteps/gravel%i.opus", i + 1 );
		cgs.media.footsteps[FOOTSTEP_GRAVEL][i] = trap_S_RegisterSound( name );

		Com_sprintf( name, sizeof( name ), "sound/player/footsteps/roof%i.opus", i + 1 );
		cgs.media.footsteps[FOOTSTEP_ROOF][i] = trap_S_RegisterSound( name );

		Com_sprintf( name, sizeof( name ), "sound/player/footsteps/snow%i.opus", i + 1 );
		cgs.media.footsteps[FOOTSTEP_SNOW][i] = trap_S_RegisterSound( name );

		Com_sprintf( name, sizeof( name ), "sound/player/footsteps/carpet%i.opus", i + 1 );    //----(SA)
	...
	//----(SA)	added
	cgs.media.grenadePulseSound4 = trap_S_RegisterSound( "sound/weapons/grenade/grenpulse4.opus" );
	cgs.media.grenadePulseSound3 = trap_S_RegisterSound( "sound/weapons/grenade/grenpulse3.opus" );
	cgs.media.grenadePulseSound2 = trap_S_RegisterSound( "sound/weapons/grenade/grenpulse2.opus" );
	cgs.media.grenadePulseSound1 = trap_S_RegisterSound( "sound/weapons/grenade/grenpulse1.opus" );
	//----(SA)	end

	//----(SA) added
	cgs.media.debBounce1Sound = trap_S_RegisterSound( "sound/world/block.opus" );
	cgs.media.debBounce2Sound = trap_S_RegisterSound( "sound/world/brick.opus" );
	cgs.media.debBounce3Sound = trap_S_RegisterSound( "sound/world/brick2.opus" );

	// Ridah
	cgs.media.flameSound = trap_S_RegisterSound( "sound/weapons/flamethrower/fl_fire.opus" );
	cgs.media.flameBlowSound = trap_S_RegisterSound( "sound/weapons/flamethrower/fl_blow.opus" );
	cgs.media.flameStartSound = trap_S_RegisterSound( "sound/weapons/flamethrower/fl_start.opus" );
	cgs.media.flameStreamSound = trap_S_RegisterSound( "sound/weapons/flamethrower/fl_stream.opus" );
	cgs.media.flameCrackSound = trap_S_RegisterSound( "sound/world/firecrack1.opus" );
	cgs.media.boneBounceSound = trap_S_RegisterSound( "sound/world/bonebounce.opus" );    // TODO: need a real sound for this

	cgs.media.lightningSounds[0] = trap_S_RegisterSound( "sound/world/electzap1.opus" );
	cgs.media.lightningSounds[1] = trap_S_RegisterSound( "sound/world/electzap2.opus" );
	cgs.media.lightningSounds[2] = trap_S_RegisterSound( "sound/world/electzap3.opus" );
	cgs.media.lightningZap = trap_S_RegisterSound( "sound/world/electrocute.opus" );
	...
	cgs.media.teslaLoopSound = trap_S_RegisterSound( "sound/weapons/tesla/loop.opus" );

	cgs.media.batsFlyingLoopSound = trap_S_RegisterSound( "sound/world/bats_flying.opus" );

	// FIXME: only needed with item
//	cgs.media.flightSound = trap_S_RegisterSound( "sound/items/flight.opus" );
//	cgs.media.medkitSound = trap_S_RegisterSound ("sound/items/use_medkit.opus");
	cgs.media.elecSound = trap_S_RegisterSound( "sound/items/use_elec.opus" );
	cgs.media.fireSound = trap_S_RegisterSound( "sound/items/use_fire.opus" );
	cgs.media.waterSound = trap_S_RegisterSound( "sound/items/use_water.opus" );
	cgs.media.wineSound = trap_S_RegisterSound( "sound/pickup/holdable/use_wine.opus" );       //----(SA)	modified
	cgs.media.bookSound = trap_S_RegisterSound( "sound/pickup/holdable/use_book.opus" );       //----(SA)	added
	cgs.media.staminaSound = trap_S_RegisterSound( "sound/pickup/holdable/use_stamina.opus" ); //----(SA)	added
	cgs.media.quadSound = trap_S_RegisterSound( "sound/items/damage3.opus" );
	cgs.media.sfx_ric1 = trap_S_RegisterSound( "sound/weapons/machinegun/ric1.opus" );
	cgs.media.sfx_ric2 = trap_S_RegisterSound( "sound/weapons/machinegun/ric2.opus" );
	cgs.media.sfx_ric3 = trap_S_RegisterSound( "sound/weapons/machinegun/ric3.opus" );
//	cgs.media.sfx_railg = trap_S_RegisterSound( "sound/weapons/railgun/railgf1a.opus" );
	cgs.media.sfx_rockexp = trap_S_RegisterSound( "sound/weapons/rocket/rocklx1a.opus" );
	cgs.media.sfx_dynamiteexp = trap_S_RegisterSound( "sound/weapons/dynamite/dynamite_exp.opus" );
	cgs.media.sfx_dynamiteexpDist = trap_S_RegisterSound( "sound/weapons/dynamite/dynamite_exp_dist.opus" );   //----(SA)	added


	cgs.media.sfx_spearhit = trap_S_RegisterSound( "sound/weapons/speargun/spearhit.opus" );

	cgs.media.sfx_knifehit[0] = trap_S_RegisterSound( "sound/weapons/knife/knife_hit1.opus" ); // hitting player
	cgs.media.sfx_knifehit[1] = trap_S_RegisterSound( "sound/weapons/knife/knife_hit2.opus" );
	cgs.media.sfx_knifehit[2] = trap_S_RegisterSound( "sound/weapons/knife/knife_hit3.opus" );
	cgs.media.sfx_knifehit[3] = trap_S_RegisterSound( "sound/weapons/knife/knife_hit4.opus" );

	cgs.media.sfx_knifehit[4] = trap_S_RegisterSound( "sound/weapons/knife/knife_hitwall1.opus" ); // hitting wall

	cgs.media.sfx_bullet_metalhit[0] = trap_S_RegisterSound( "sound/weapons/bullethit_metal1.opus" );
	cgs.media.sfx_bullet_metalhit[1] = trap_S_RegisterSound( "sound/weapons/bullethit_metal2.opus" );
	cgs.media.sfx_bullet_metalhit[2] = trap_S_RegisterSound( "sound/weapons/bullethit_metal3.opus" );

	cgs.media.sfx_bullet_woodhit[0] = trap_S_RegisterSound( "sound/weapons/bullethit_wood1.opus" );
	cgs.media.sfx_bullet_woodhit[1] = trap_S_RegisterSound( "sound/weapons/bullethit_wood2.opus" );
	cgs.media.sfx_bullet_woodhit[2] = trap_S_RegisterSound( "sound/weapons/bullethit_wood3.opus" );

	cgs.media.sfx_bullet_roofhit[0] = trap_S_RegisterSound( "sound/weapons/bullethit_roof1.opus" );
	cgs.media.sfx_bullet_roofhit[1] = trap_S_RegisterSound( "sound/weapons/bullethit_roof2.opus" );
	cgs.media.sfx_bullet_roofhit[2] = trap_S_RegisterSound( "sound/weapons/bullethit_roof3.opus" );

	cgs.media.sfx_bullet_ceramichit[0] = trap_S_RegisterSound( "sound/weapons/bullethit_ceramic1.opus" );
	cgs.media.sfx_bullet_ceramichit[1] = trap_S_RegisterSound( "sound/weapons/bullethit_ceramic2.opus" );
	cgs.media.sfx_bullet_ceramichit[2] = trap_S_RegisterSound( "sound/weapons/bullethit_ceramic3.opus" );

	cgs.media.sfx_bullet_glasshit[0] = trap_S_RegisterSound( "sound/weapons/bullethit_glass1.opus" );
	cgs.media.sfx_bullet_glasshit[1] = trap_S_RegisterSound( "sound/weapons/bullethit_glass2.opus" );
	cgs.media.sfx_bullet_glasshit[2] = trap_S_RegisterSound( "sound/weapons/bullethit_glass3.opus" );

	// RealRTCW brass sound
	cgs.media.sfx_brassSound_metal[0] = trap_S_RegisterSound("sound/weapons/misc/shell_metal1.opus" );
	cgs.media.sfx_brassSound_metal[1] = trap_S_RegisterSound("sound/weapons/misc/shell_metal2.opus" );
	cgs.media.sfx_brassSound_metal[2] = trap_S_RegisterSound("sound/weapons/misc/shell_metal3.opus" );

	cgs.media.sfx_brassSound_soft[0] = trap_S_RegisterSound("sound/weapons/misc/shell_soft1.opus" );
	cgs.media.sfx_brassSound_soft[1] = trap_S_RegisterSound("sound/weapons/misc/shell_soft2.opus" );
	cgs.media.sfx_brassSound_soft[2] = trap_S_RegisterSound("sound/weapons/misc/shell_soft3.opus" );

	cgs.media.sfx_brassSound_stone[0] = trap_S_RegisterSound("sound/weapons/misc/shell_stone1.opus" );
	cgs.media.sfx_brassSound_stone[1] = trap_S_RegisterSound("sound/weapons/misc/shell_stone2.opus" );
	cgs.media.sfx_brassSound_stone[2] = trap_S_RegisterSound("sound/weapons/misc/shell_stone3.opus" );

	cgs.media.sfx_brassSound_wood[0] = trap_S_RegisterSound("sound/weapons/misc/shell_wood1.opus" );
	cgs.media.sfx_brassSound_wood[1] = trap_S_RegisterSound("sound/weapons/misc/shell_wood2.opus" );
	cgs.media.sfx_brassSound_wood[2] = trap_S_RegisterSound("sound/weapons/misc/shell_wood3.opus" );
	
	cgs.media.sfx_rubbleBounce[i]                    = trap_S_RegisterSound("sound/world/debris%i.opus" );

	cgs.media.sparkSounds[0] = trap_S_RegisterSound( "sound/world/saarc2.opus" );
	cgs.media.sparkSounds[1] = trap_S_RegisterSound( "sound/world/arc2.opus" );
...
//----(SA)	doors and kick
	...
	trap_S_RegisterSound( "sound/weapons/melee/fstatck.opus" );
	trap_S_RegisterSound( "sound/weapons/melee/fstmiss.opus" );

	trap_S_RegisterSound( "sound/Loogie/spit.opus" );
	trap_S_RegisterSound( "sound/Loogie/sizzle.opus" );
}
...
//	cg.weaponSelect = WP_MP40;
	...
	// too late...
//	trap_S_StartBackgroundTrack( "sound/music/fla_mp03.opus", "sound/music/fla_mp03.opus", 1 );
