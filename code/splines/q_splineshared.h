...
#else
  #define PRODUCT_NAME			"RepackTCW" // iortcw
  #define BASEGAME			"main"
  #define CLIENT_WINDOW_TITLE     	"Repack to Castle Wolfenstein"
  #define CLIENT_WINDOW_MIN_TITLE 	"RepackTCW" // iowolfsp
#ifdef USE_XDG
  #define HOMEPATH_NAME_UNIX		"RepackTCW"
#else
  #define HOMEPATH_NAME_UNIX		".wolf_repack"
#endif
  #define HOMEPATH_NAME_WIN		"RepackTCW"
  #define HOMEPATH_NAME_MACOSX		HOMEPATH_NAME_WIN
